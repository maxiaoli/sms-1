...
public interface TemplateMapper {
    ...
    @Insert({
        ...
        "signature_id, chnl_template_id, ",
        "`name`, template_id, ",
        "`desc`, `usage`, `status`, ",
        "create_time, update_time, ",
        "delete_flag)",
        "values (#{id,jdbcType=INTEGER}, #{clientId,jdbcType=INTEGER}, ",
        "#{signatureId,jdbcType=INTEGER}, #{chnlTemplateId,jdbcType=INTEGER}, ",
    ...
    @Results({
        ...
        @Result(column="signature_id", property="signatureId", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        "select",
        "id, client_id, signature_id, chnl_template_id, `name`, template_id, `desc`, ",
    ...
    @Update({
        ...
        "set client_id = #{clientId,jdbcType=INTEGER},",
          "signature_id = #{signatureId,jdbcType=INTEGER},",
