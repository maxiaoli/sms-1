...
public class TemplateDO implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSignatureId() == null ? other.getSignatureId() == null : this.getSignatureId().equals(other.getSignatureId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSignatureId() == null) ? 0 : getSignatureId().hashCode());
